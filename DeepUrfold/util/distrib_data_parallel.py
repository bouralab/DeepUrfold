...
class TrainerDDPMixin(ABC):
    ...
    def set_distributed_mode(self, distributed_backend):
        ...
        print("SET DISTRIBUTED MODE", distributed_backend, self.num_gpus,  self.num_nodes)
    ...
    def _set_horovod_backend(self):
        ...
        print("ROOT GPU", self.root_gpu, "LOCAL_RANK", hvd.local_rank(), os.environ["SLURMD_NODENAME"])
