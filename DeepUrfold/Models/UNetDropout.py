...
class UNetDropout(nn.Module):
    def __init__(self, dimension, reps, nPlanes, residual_blocks=False, dropout_p=0.5, downsample=[2, 2], leakiness=0):
...
def UNetDropout2(dimension, reps, nPlanes, residual_blocks=False, dropout_p=0.5, downsample=[2, 2], leakiness=0):
    """
