...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["domain_communities.json",new URL("./files/domain_communities.json",import.meta.url)]]);
...
FileAttachment("domain_communities.json").json()
)});
