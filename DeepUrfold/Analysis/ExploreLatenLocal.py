...
class ExploreLatent():
    @staticmethod
    def reduce(*files, group_name="superfamily", plot=True, method="umap", prefix="UMAP", **labelled_files):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-p", "--prefix", default="UMAP-latent-space")
    parser.add_argument("-m", "--method", default="umap", choices=["umap", "t-sne", "pca"])
    parser.add_argument("files", nargs="+", default=None, help="Path to pytorch tensof files")
    args = parser.parse_args()

    ExploreLatent.reduce(*args.umap, prefix=args.prefix)
